...
class FaucetStackRingOfDPTest(FaucetStringOfDPTest):
    ...
    def setUp(self): # pylint: disable=invalid-name
        ...
        self.build_net(
            ...
            stack_ring=True)
        self.start_net()
        # get two hosts on two different non-root dps
        self.first_host = self.net.hosts[self.NUM_HOSTS]
        self.last_host = self.net.hosts[(self.NUM_DPS - 1)*self.NUM_HOSTS - 1]
    ...
    def verify_stack_has_no_loop(self):
        ...
        num_arp_expected = self.topo.switch_to_switch_links
