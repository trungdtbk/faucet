...
class FaucetMetrics(object):
    ...
    def __init__(self, prom_port, prom_addr):
        ...
        self.router_neighbors = Gauge(
            'neighbors',
            'number of neighbors on a dp', ['dpid', 'router', 'ipv'])
        ...
        self.bgp_neighbor_uptime_seconds = Gauge(
            'bgp_neighbor_uptime',
            'BGP neighbor uptime in seconds', ['router', 'neighbor'])
        self.bgp_neighbor_routes = Gauge(
            'bgp_neighbor_routes',
            'BGP neighbor route count', ['router', 'neighbor', 'ipv'])
